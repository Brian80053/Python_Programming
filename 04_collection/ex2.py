...
print(result)
# 중첩 for문도 가능
result = [ x*y for x in range(0,3) for y in range(0,3)]
print(result)
...
result = [x for x in words if x.find("n")!=-1]  
...
# result = [sum([scores[x][score] for x in range(3)])/3 for score in range(3)]
