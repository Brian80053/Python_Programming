...
# print(dir(str))                       # str 자료형이 제공하는 속성과 메소드 목록
# print(dir(int))                      # int 자료형이 제공하는 속성과 메소드 목록
# print(dir(list))                      # list 자료형이 제공하는 속성과 메소드 목록
...
print(a.swapcase())                 # 각 단어의 소문자와 대문자를 서로 변환

# 문자열의 공백문자 or 특정문자를 제거하는 문자열 메소드
a = "\t  python  \n"
print("[" + a + "]",sep="")
print("[" + a.lstrip() + "]",sep="")       # 왼쪽 공백문자 제거
print("[" + a.rstrip() + "]",sep="")       # 오른쪽 공백문자 제거
print("[" + a.strip() + "]",sep="")        # 양쪽 공백문자 제거
...
# 문제) replace는 원본 문자열을 바꿀까요? 새로운 문자열을 만들까요? A:새로운 문자열을 만든다
